...
export function useStyleConfig(componentKey: string, props: StyleModifiers, placeholderSelectors: PseudoSelectors, internalStyles?: any): {
    selectors: import('@maestroqa/ui-box').EnhancerProps['selectors'];
    style: import('react').CSSProperties;
} & import('@maestroqa/ui-box').EnhancerProps;
...
export type Style = import('@maestroqa/ui-box').EnhancerProps & StateStyles;
